''' This file downloads all nessesary data from the internet for prokaryotes genomes '''
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(prog='prokaryotes_dowload.py')
    parser.add_argument("-r", "--release", dest="release", type=str,
                        help="release version [ex 24], default = current release",
                        required = False, default="current")
    parser.add_argument("-o", "--organism", dest="organism", type=str,
                        help="species name [ex escherichia_coli_is29], default = escherichia_coli_is29 (e. coli)",
                        required = False, default = "escherichia_coli_is29")
